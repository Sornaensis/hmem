...
instance ToSchema WorkspaceProjectMemoryLink where declareNamedSchema = genericDeclareNamedSchema opts
instance ToSchema WorkspaceTaskMemoryLink    where declareNamedSchema = genericDeclareNamedSchema opts
instance ToSchema WorkspaceTaskDependencyLink where declareNamedSchema = genericDeclareNamedSchema opts
instance ToSchema WorkspaceCardHydration     where declareNamedSchema = genericDeclareNamedSchema opts
